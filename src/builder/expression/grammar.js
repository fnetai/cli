...
function peg$parse(input, options) {
  ...
  const peg$r0 = /^[a-z]/;
  const peg$r1 = /^[a-z0-9_\-]/;
  const peg$r2 = /^[^s]/;
  const peg$r3 = /^[sS]/;

  const peg$e0 = peg$literalExpectation("::", false);
  const peg$e1 = peg$classExpectation([["a", "z"]], false, false, false);
  const peg$e2 = peg$classExpectation([["a", "z"], ["0", "9"], "_", "-"], false, false, false);
  const peg$e3 = peg$classExpectation(["s"], true, false, false);
  const peg$e4 = peg$classExpectation(["s", "S"], false, false, false);

  function peg$f0(expr) {    return buildFullResult(expr);  }
  function peg$f1(processor, statement) {
